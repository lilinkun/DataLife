...
public class SettingActivity extends BaseActivity implements EasyPermissions.PermissionCallbacks,SettingContract.SettingView {
    /**
     * 下载文件权限请求码
     */
    ...
    public void onClick(View view){
        ...
        switch (view.getId()){
            ...
            case R.id.rl_wx_login:
                ...
                try {
                    loginBean = (LoginBean) DataLifeUtil.deSerialization(sharedPreferences.getString("logininfo",""));
                }catch (Exception e){
