package com.datalife.datalife.wxapi;
...
import com.datalife.datalife.bean.WxInfomation;
...
import com.datalife.datalife.util.OkHttpUtils;
                ...
                OkHttpUtils.ResultCallback<String> reCallback = new OkHttpUtils.ResultCallback<String>() {
                    ...
                    public void onSuccess(String responses) {
                        ...
                        try {
                            ...
                            Log.e("LG","00000000000000responses:" + wxInfomation.toString());
