...
public class MachineBindMemberBean implements Serializable{
    ...
    public MachineBindMemberBean(String MM_Id, String MachineBindId,
            String Machine_Id, String Member_Id, String user_id, String user_name,
            String bindType, String MM_Status, String Create_Date) {
        this.MM_Id = MM_Id;
