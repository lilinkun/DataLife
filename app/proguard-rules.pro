...
-keep class com.datalife.datalife.bean.**{*;}

-keep class com.datalife.datalife.widget.**{*;}
...
-keep class com.datalife.datalife.http.**{*;}
-keep class com.datalife.datalife.util.** {*;}
